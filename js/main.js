...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const API_URL = "https://api.academianichele.com.br/api/cursos/ead";
      ...
      const card = `
        <div class="col s12 m6 l4">
          <div class="card curso-card">
            ...
            <div class="card-image curso-img">
              <img class="activator"
                   src="${curso.imagem_url || '/img/curso-sem-imagem.jpg'}"
                   alt="${curso.titulo}">
            </div>
            ...
            <div class="card-content">
              ...
              <p>
                ...
                <strong>Carga horária:</strong> ${curso.carga_horaria || 0}h
              </p>
            </div>
            ...
            <div class="card-reveal">
              ...
              <p>${curso.objetivo || 'Sem descrição disponível.'}</p>
            </div>
